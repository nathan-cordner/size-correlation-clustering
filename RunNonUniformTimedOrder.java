...
public class RunNonUniformTimedOrder {
    ...
    public static void main(String args[]){
        ...
        ArrayList<ArrayList<Integer>> pivot_result = PKwik.nonUniformMaxPivotOrder(prob_matrix, size_bounds);
        ...
        ArrayList<ArrayList<Integer>> blend_result = DNode.nonuniform_random_node_network(prob_matrix, size_bounds, true); // DNode.max_k_random_node_network(prob_matrix, k);
        ...
        ArrayList<ArrayList<Integer>> fix = pivot_result; // DNode.local_search_network_nonuniform_timed(copy1, prob_matrix, size_bounds, hybridStart, fiveMinuteLimit);
