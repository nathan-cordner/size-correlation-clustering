...
public class RunNonUniformTimed {
    ...
    public static void main(String args[]){
        ...
        int[] k_vals = {0}; //, 15, 20, 25, 30, 35, 40, 45, 50};
        ...
        ArrayList<ArrayList<Integer>> pivot_result = PKwik.nonUniformMaxPivot(prob_matrix, size_bounds);
        ...
        ArrayList<ArrayList<Integer>> blend_result = DNode.nonuniform_random_node_network(prob_matrix, size_bounds, false); // DNode.max_k_random_node_network(prob_matrix, k);
        ...
        ArrayList<ArrayList<Integer>> fix = DNode.local_search_network_nonuniform_timed(copy1, prob_matrix, size_bounds, hybridStart, fiveMinuteLimit); // Hybrid.large_graph_fix_clusters(pivot_result, prob_matrix);
        ...
        // System.out.println("Start Vote LS");
        ArrayList<ArrayList<Integer>> ls_result = DNode.local_search_network_nonuniform_timed(copy2, prob_matrix, size_bounds, lsStart, fiveMinuteLimit);
