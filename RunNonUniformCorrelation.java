...
public class RunNonUniformCorrelation {
    ...
    public static void main(String args[]){
        ...
        ArrayList<ArrayList<Integer>> fix = DNode.local_search_network_nonuniform(copy1, prob_matrix, size_bounds, -1); // Hybrid.large_graph_fix_clusters(pivot_result, prob_matrix);
        ...
        ArrayList<ArrayList<Integer>> ls_result = DNode.local_search_network_nonuniform(copy2, prob_matrix, size_bounds, -1);
